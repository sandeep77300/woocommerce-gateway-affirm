...
class WC_Affirm_Privacy extends WC_Abstract_Privacy {
	...
	public function __construct() {
		...
		$this->add_exporter( 'woocommerce-gateway-affirm-order-data', __( 'WooCommerce Affirm Order Data', 'woocommerce-gateway-affirm' ), array( $this, 'order_data_exporter' ) );

		$this->add_eraser( 'woocommerce-gateway-affirm-order-data', __( 'WooCommerce Affirm Data', 'woocommerce-gateway-affirm' ), array( $this, 'order_data_eraser' ) );
	}
