...
if (! class_exists('WooThemes_Updater')  
    && ! function_exists('woothemes_updater_install') 
) {
 ...
 */
if (! class_exists('WooThemes_Updater')  
    && ! function_exists('woothemes_updater_notice') 
) {
    ...
    function woothemes_updater_notice()
    {
        ...
        esc_url(
            $install_url
        ) . '">Install the WooThemes Updater plugin</a>'.
            ' to get updates for your WooThemes plugins.';
        $is_downloaded = false;
            ...
            if (strpos($plugin, 'woothemes-updater.php') !== false ) {
                ...
                esc_url(
                    admin_url(
                        ...
                        '">Activate the WooThemes Updater plugin</a>'.
                        ' to get updates for your WooThemes plugins.';
            }
        }
